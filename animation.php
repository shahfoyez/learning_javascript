<?php include 'shared/header.php';?>
    <div class="foy-main">
        <div class="foy-container">
            ...
            <div class="foy-text-center mb-10">
                ...
                <button class="foy_button mt-10" id="foy_button2" >Click ME</button>
    ...
    <script>
        const foy_button = document.getElementById();
        ...
        function myMove(){
            ...
            animate.style.top = "0px !important";
            animate.style.left ="0px !important";
            let pos = 0;
            // clearInterval(id);
